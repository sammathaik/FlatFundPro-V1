import { CheckCircle, Circle, TrendingUp, TrendingDown, AlertCircle, Clock } from 'lucide-react';
...
interface FlatStatus {
  ...
  payment_status: 'paid' | 'under_review' | 'underpaid' | 'overpaid' | 'unpaid';
  total_paid: number;
  amount_due: number;
        ...
        <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-900">Paid & Approved</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-900">Under Review</div>
                <div className="text-xs text-gray-600">{statusCounts.under_review || 0} flats</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-orange-100 border-2 border-orange-500 rounded flex items-center justify-center">
                <TrendingDown className="w-5 h-5 text-orange-600" />
              </div>
              <div>
                <div className="text-sm font-semibold text-gray-900">Partially Paid</div>
                <div className="text-xs text-gray-600">{statusCounts.underpaid || 0} flats</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-cyan-100 border-2 border-cyan-500 rounded flex items-center justify-center">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gray-100 border-2 border-gray-500 rounded flex items-center justify-center">
                <Circle className="w-5 h-5 text-gray-600" />
              </div>
              <div>
                <div className="text-sm font-semibold text-gray-900">Not Paid</div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border-2 border-blue-200">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
          <div>
            ...
            <div className="text-sm text-gray-600">Paid & Approved</div>
          </div>
          <div>
          ...
          <div>
            <div className="text-2xl font-bold text-orange-600">{statusCounts.underpaid || 0}</div>
            <div className="text-sm text-gray-600">Partially Paid</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-cyan-600">{statusCounts.overpaid || 0}</div>
            <div className="text-sm text-gray-600">Overpaid</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-gray-600">{statusCounts.unpaid || 0}</div>
