...
import { Bell, CheckCircle, AlertTriangle, AlertCircle, Info, Eye, Filter, UserPlus } from 'lucide-react';
...
export default function SuperAdminNotificationsPage() {
  ...
  }, [superAdminData, filter, severityFilter]);

  async function loadNotifications() {
    if (!superAdminData?.user_id) return;
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-8 text-white shadow-lg">
        ...
        <p className="text-purple-100">
          View and manage all system-wide notifications and alerts
        </p>
      </div>
            ...
            {notifications.map((notification) => (
              <div
                ...
                className={`border rounded-lg p-5 transition-all hover:shadow-md ${
                  notification.is_read ? 'bg-gray-50' : 'bg-white border-purple-200'
                      ...
                      <div className="flex items-center gap-2">
                        {!notification.is_read && (
                          <button
                            ...
                            className="flex items-center gap-1 px-3 py-1 text-xs text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-colors"
                          >
