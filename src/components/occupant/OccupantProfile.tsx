import { User, Building, Mail, Phone, Info, Shield } from 'lucide-react';
...
export default function OccupantProfile({ occupant, apartmentInfo }: OccupantProfileProps) {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm">View your personal information</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 flex items-start gap-3 mb-6">
          ...
          <div>
            <p className="text-sm text-blue-900 font-semibold mb-1">Profile Information is Read-Only</p>
            <p className="text-sm text-blue-800">
              To maintain data integrity, your profile information can only be updated by your apartment committee.
              Please contact your management committee if you need to update your details.
            </p>
          </div>
        </div>
