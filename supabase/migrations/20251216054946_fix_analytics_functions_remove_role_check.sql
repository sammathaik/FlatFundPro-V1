/*
  # Fix Analytics Functions - Remove Non-existent Role Check

  1. Changes
    - Remove role column references from all analytics functions
    - Simplify access control to just check if user is an admin
    - Verify apartment_id matches for regular admins
    
  2. Security
    - Maintain proper access control without role column
*/
...
BEGIN
  ...
  -- If not super admin, check if regular admin with access to this apartment
