/*
  # Fix Super Admin Executive Summary - Use Correct Fraud Columns

  1. Changes
    - Update fraud_detection_stats to use correct column names
    - Use is_fraud_flagged instead of fraud_detected
    - Ensure proper filtering for fraud statistics
...
BEGIN
  ...
  fraud_detection_stats AS (
    SELECT
      COUNT(*) FILTER (WHERE is_fraud_flagged = true) as total_fraud_detected,
