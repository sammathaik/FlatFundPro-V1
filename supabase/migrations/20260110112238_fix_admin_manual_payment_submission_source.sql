/*
  # Fix Admin Manual Payment - Correct submission_source Value

  ## Overview
  Fixes the submission_source value in create_admin_manual_payment function to match
  the check constraint on payment_submissions table.

  ## Issue
  The function was using submission_source = 'admin_portal' but the constraint only allows:
  - 'resident'
  - 'admin_on_behalf'

  ## Fix
  Update submission_source to 'admin_on_behalf' which is the correct value for admin-created payments.

  ## Verification
  Tested with dummy data for F-10 - record creation successful with correct constraint values.
*/
...
BEGIN
  ...
  INSERT INTO payment_submissions (
    ...
    NULL,
    NULL,
    'admin_on_behalf',  -- FIXED: Changed from 'admin_portal' to 'admin_on_behalf'
    'submit_on_behalf'
  )
