/*
  # Fix Approval Notification Trigger - Column Name Issue
  
  1. Problem
    - Trigger references 'whatsapp_notifications_enabled' but column is 'whatsapp_opt_in'
  
  2. Solution
    - Update trigger to use correct column name 'whatsapp_opt_in'
*/
...
'Sends email and WhatsApp notifications when payment is approved. Uses case-insensitive status check. Uses correct column name whatsapp_opt_in. Logs all communications to unified audit trail. Non-blocking - never fails payment approval.';
